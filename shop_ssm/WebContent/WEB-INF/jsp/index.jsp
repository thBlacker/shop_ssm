			...
			<div id="hotProduct" class="hotProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					<c:forEach items="${hList}" var="p">
						<li>
						<a target="_blank" href="${ pageContext.request.contextPath }/product_findByPid?pid=${p.pid}">
				...
				<ul class="tabContent" style="display: none;">
					...
					<li><a target="_blank">
						<img src="./Mango商城 - Powered By Mango Team_files/4107e1ce-5e7c-4941-bc0f-718f35ba14cd-thumbnail.jpg"
					...
					<li><a target="_blank">
						<img src="./Mango商城 - Powered By Mango Team_files/6f8ae4bf-cbd3-41c7-aa22-0fe81db6add4-thumbnail.jpg"
			...
			<div id="newProduct" class="newProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					<c:forEach var="p" items="${nList}">
						<li>
							<a href="${ pageContext.request.contextPath }/product_findByPid?pid=${p.pid}" target="_blank">
							<img src="${pageContext.request.contextPath}/${p.image}"
